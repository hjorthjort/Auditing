...
import {
    ...
    IEntryPoint,
    PackedUserOperation
} from "eth-infinitism-account-abstraction-0.7/contracts/core/BaseAccount.sol";
...
abstract contract Account is BaseAccount {
     ...
     */
    IEntryPoint private constant _entryPoint = IEntryPoint(0x5FF137D4b0FDCD49DcA30c7CF57E578a026d2789);
