...
/// @title NFT positions
/// @notice Wraps Shadow V3 positions in the ERC721 non-fungible token interface
...
{
    /// @dev details about the Shadow position
    struct Position {
        ...
        returns (uint256 amount0, uint256 amount1)
    {
        ...
        PoolAddress.PoolKey memory poolKey = _poolIdToPoolKey[position.poolId];
        IShadowV3Pool pool = IShadowV3Pool(PoolAddress.computeAddress(deployer, poolKey));
