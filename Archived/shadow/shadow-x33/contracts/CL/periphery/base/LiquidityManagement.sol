...
/// @notice Internal functions for safely managing liquidity in Shadow V3
abstract contract LiquidityManagement is IUniswapV3MintCallback, PeripheryImmutableState, PeripheryPayments {
    ...
    function addLiquidity(
    ...
    ) internal returns (uint128 liquidity, uint256 amount0, uint256 amount1, IShadowV3Pool pool) {
        ...
        /// @dev compute the liquidity amount
        {
        ...
        if (amount0 < params.amount0Min || amount1 < params.amount1Min) revert Slippage();
    }
}
