...
/// @title Shadow V3 Swap Router
/// @notice Router for stateless execution of swaps against Shadow V3
    ...
    SelfPermit
{
    ...
    function getPool(address tokenA, address tokenB, int24 tickSpacing) private view returns (IShadowV3Pool) {
        return IShadowV3Pool(PoolAddress.computeAddress(deployer, PoolAddress.getPoolKey(tokenA, tokenB, tickSpacing)));
    }
    ...
    function uniswapV3SwapCallback(int256 amount0Delta, int256 amount1Delta, bytes calldata _data) external override {
        ...
        (address tokenIn, int24 tickSpacing, address tokenOut) = data.path.decodeFirstPool();
    ...
    function exactOutputInternal(
        ...
        (address tokenOut, int24 tickSpacing, address tokenIn) = data.path.decodeFirstPool();
    ...
    function exactOutputSingle(
        ...
        amountIn = exactOutputInternal(
            ...
            params.recipient,
            params.sqrtPriceLimitX96,
            SwapCallbackData({path: abi.encodePacked(params.tokenOut, params.tokenIn, params.tickSpacing), payer: msg.sender})
        );
