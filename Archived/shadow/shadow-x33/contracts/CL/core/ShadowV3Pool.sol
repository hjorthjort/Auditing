...
import {
    ...
    IShadowV3Pool
} from "./interfaces/IShadowV3Pool.sol";
...
contract ShadowV3Pool is IShadowV3Pool {
    ...
    constructor() {
        ...
        (factory, token0, token1, $.fee, tickSpacing) = IShadowV3PoolDeployer(msg.sender).parameters();
    ...
    /// @inheritdoc IShadowV3PoolDerivedState
    ...
    /// @inheritdoc IShadowV3PoolActions
    ...
    function swap(
        ...
        if (period != _lastPeriod) {
            ...
            uint160 secondsPerLiquidityCumulativeX128 =
                Oracle.newPeriod($.observations, slot0Start.observationIndex, period);
    ...
    /// @inheritdoc IShadowV3PoolOwnerActions
    ...
    {
        require(msg.sender == IShadowV3Factory(factory).feeCollector(), ProtocolActions.NOT_AUTHORIZED());
