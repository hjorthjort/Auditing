...
contract PairTest is TestBase {
    ...
    function test_revertSkimDisabled() public {
        ...
        vm.expectRevert(abi.encodeWithSelector(Errors.SKIM_DISABLED.selector)); // SKIM_DISABLED() - Skim Disabled
        pair.skim(bob);
    }
    ...
    function test_revertSetFeeRecipientUnauthorized() public {
        ...
        vm.startPrank(alice);
        vm.expectRevert(abi.encodeWithSelector(Errors.NOT_AUTHORIZED.selector)); // NOT_AUTHORIZED()
        pair.setFeeRecipient(address(feeRecipient));
    }
    ...
    function test_revertMintWithZeroLiquidity() public {
        ...
        vm.expectRevert(abi.encodeWithSelector(Errors.INSUFFICIENT_LIQUIDITY_MINTED.selector)); // INSUFFICIENT_LIQUIDITY_MINTED() - Insufficient Liquidity Minted
        pair.mint(alice);
    }
    ...
    function test_revertMintStablePairImbalanced() public {
        ...
        vm.expectRevert(abi.encodeWithSelector(Errors.UNSTABLE_RATIO.selector)); // UNSTABLE_RATIO()
    ...
    function test_revertBurnWithoutLiquidity() public {
        ...
        vm.expectRevert(abi.encodeWithSelector(Errors.INSUFFICIENT_LIQUIDITY_BURNED.selector)); // INSUFFICIENT_LIQUIDITY_BURNED()() - Insufficient Liquidity Burned
        pair.burn(alice);
    }
    ...
    function test_revertSwapInsufficientOutputAmount() public {
        ...
        vm.startPrank(bob);
        vm.expectRevert(abi.encodeWithSelector(Errors.INSUFFICIENT_OUTPUT_AMOUNT.selector)); // INSUFFICIENT_OUTPUT_AMOUNT() - Insufficient Output Amount
        pair.swap(0, 0, bob, "");
    }
    ...
    function test_revertSwapInsufficientLiquidity() public {
        ...
        vm.startPrank(bob);
        vm.expectRevert(abi.encodeWithSelector(Errors.INSUFFICIENT_LIQUIDITY.selector)); // INSUFFICIENT_LIQUIDITY() - Insufficient Liquidity
    ...
    function test_revertSwapInvalidTo() public {
        ...
        vm.startPrank(bob);
        vm.expectRevert(abi.encodeWithSelector(Errors.INVALID_TRANSFER.selector)); // INVALID_TRANSFER() - Invalid To
    ...
    function test_revertSwapInsufficientInputAmount() public {
        ...
        vm.startPrank(bob);
        vm.expectRevert(abi.encodeWithSelector(Errors.INSUFFICIENT_INPUT_AMOUNT.selector)); // IIA() - Insufficient Input Amount
    ...
    function test_revertSwapK() public {
        ...
        vm.startPrank(bob);
        token0Sorted.transfer(address(pair), 1e18);
        vm.expectRevert(abi.encodeWithSelector(Errors.K.selector)); // K invariant violation
