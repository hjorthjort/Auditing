...
contract FeeDistributorFactoryTest is TestBase {
    ...
    function test_createFeeDistributor() public {
        ...
        assertEq(address(distributor.voter()), address(mockVoter), "Voter not set correctly");
        assertEq(distributor.feeRecipient(), address(feeRecipient), "Fee recipient not set correctly");
        assertEq(address(distributor.voteModule()), mockVoter.voteModule(), "Vote module not set correctly");
    ...
    function test_createMultipleFeeDistributors() public {
        ...
        assertEq(address(distributor1.voter()), address(mockVoter), "First distributor voter not set correctly");
        assertEq(
            distributor1.feeRecipient(), address(feeRecipient), "First distributor fee recipient not set correctly"
        );
        assertEq(address(distributor1.voteModule()), mockVoter.voteModule(), "First distributor vote module not set correctly");
        assertEq(
        ...
        assertEq(address(distributor2.voter()), address(mockVoter), "Second distributor voter not set correctly");
        assertEq(distributor2.feeRecipient(), secondRecipient, "Second distributor fee recipient not set correctly");
        assertEq(address(distributor2.voteModule()), mockVoter.voteModule(), "Second distributor vote module not set correctly");
        assertEq(
