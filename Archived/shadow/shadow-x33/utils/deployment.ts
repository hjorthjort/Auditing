...
export async function deploy(config: CoreConfig) {
    const [
        ...
        ethers.getContractFactory("ShadowV3Factory"),
        ...
        ethers.getContractFactory("ShadowTransparentUpgradeableProxy"),
        ethers.getContractFactory("Shadow"),
    ...
    ) as typechain.ShadowV3Factory;
    const clPoolDeployer = ClPoolDeployer.attach(
        immutableAddresses["ClPoolDeployer"]!,
    ) as typechain.ShadowV3PoolDeployer;
