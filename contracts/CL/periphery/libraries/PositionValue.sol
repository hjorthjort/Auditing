...
/// @title Returns information about the token value held in a Shadow V3 NFT
library PositionValue {
    /// @notice Returns the total amounts of token0 and token1, i.e. the sum of fees and principal
    /// that a given nonfungible position manager token is worth
    /// @param positionManager The Shadow V3 NonfungiblePositionManager
    ...
    function _getFeeGrowthInside(IShadowV3Pool pool, int24 tickLower, int24 tickUpper)
        private
        view
